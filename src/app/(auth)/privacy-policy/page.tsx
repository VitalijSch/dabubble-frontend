...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-[800px] max-h-[750px] w-full h-full pb-[100px] bg-[#FFFFFF] rounded-[30px] shadow-[0px_2px_10px_0px_#00000014] overflow-hidden relative">
        <BackButton className="absolute top-[40px] left-[32px]" />
      <div className="h-full flex flex-col gap-[30px] items-center mt-[40px] mb-[60px] mx-[80px] text-[20px] text-[#686868] overflow-scroll scrollbar-hidden">
        <h2 className="text-[28px] text-[#444DF2] whitespace-nowrap">1. Datenschutz auf einen Blick</h2>
        ...
        <h2 className="text-[28px] text-[#444DF2] whitespace-nowrap">2. Hosting</h2>
        ...
        <h2 className="text-[28px] text-[#444DF2] whitespace-nowrap">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
        <h3>Datenschutz</h3>
        <p>
        ...
        <p>
          Telefon: 017663373456
          <br />
          E-Mail: schwab.vitalij@gmail.com
        </p>
        <p>
        ...
        <h2 className="text-[28px] text-[#444DF2] whitespace-nowrap">4. Datenerfassung auf dieser Website</h2>
        ...
        <h2 className="text-[28px] text-[#444DF2] whitespace-nowrap">5. Plugins und Tools</h2>
