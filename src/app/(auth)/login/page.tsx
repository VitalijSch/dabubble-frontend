    ...
    <div className="max-w-[606px] max-h-[769px] w-full h-full flex flex-col gap-[30px] items-center py-[50px] px-[60px] mb-[65px] bg-[#FFFFFF] rounded-[30px] shadow-[0px_2px_10px_0px_#00000014]">
      ...
      <form className="w-full h-full flex flex-col justify-between">
        ...
        <FormInput
          ...
          Icon={LockIcon}
        />
        <span className="w-fit self-center text-[18px] text-[#797EF3] figtree py-[5px] px-[15px] rounded-[30px] cursor-pointer hover:bg-[#ECEEFE] hover:text-[#444DF2] transition-all duration-300 ease-in-out">
          Passwort vergessen?
        </span>
